    ...
    <div class="max-w-5xl mx-auto px-4 py-10">
        ...
        <div class="mb-6 text-center">
            ...
            <form action="{{ route('auth.logout') }}" method="POST">
                @csrf
                <button type="submit" class="inline-block bg-red-600 hover:bg-red-700 text-white text-sm font-medium py-2 px-5 my-1 rounded shadow">
            ...
            <div class="bg-white rounded-lg shadow-md p-5 mb-6 flex flex-col sm:flex-row gap-4">
                ...
                <div class="flex-1">
                    ...
                    <div class="text-sm text-gray-600 mt-3 flex items-center gap-2">
                        Status:
                        <span class="inline-block px-3 py-0.5 text-sm font-medium rounded-full
